module Lol
  ...
  class MatchRequest < V3Request
    ...
    # @param [Fixnum] match_id Match ID
    ...
    # @return [Array<Fixnum>] List of match IDs
    ...
    # @option options [Array<Fixnum>] queue Set of queue IDs for which to filtering matchlist.
    # @option options [Fixnum] beginTime The begin time to use for filtering matchlist specified as epoch milliseconds.
    # @option options [Fixnum] endTime The end time to use for filtering matchlist specified as epoch milliseconds.
    # @option options [Fixnum] beginIndex The begin index to use for filtering matchlist.
    # @option options [Fixnum] endIndex The end index to use for filtering matchlist.
    # @option options [Array<Fixnum>] season Set of season IDs for which to filtering matchlist.
    # @option options [Array<Fixnum>] champion Set of champion IDs for which to filtering matchlist.
